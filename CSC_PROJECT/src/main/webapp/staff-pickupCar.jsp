...
select * from cars join booking using (carid) join customer using (custid) where bookstatus='Approved'
</sql:query>
              ...
              <tr>
                  ...
                  <td>
                      <form method="post">
                          ...
                          <button  class="action"  type="print" formaction="CarServlet"  onclick="return confirm('Confirm Picked?')">CAR PICKED</button>
                      </form>
