...
select * from cars join booking using (carid) join customer using (custid) where bookstatus='In Rent'
</sql:query>
		...
		<table style="text-align: center;" id="carList">
          <tr>
             ...
             <th style="width:400px;">Customer Name</th>
              ...
              <th style="width: 200px;">Car Plate</th>
          ...
          <c:forEach var="result" items="${car.rows}">
              <tr>
                  ...
                  <td>
                        <form method="post">
                            <button  class="action"  type="print" formaction="staff-returnConfirm.jsp?id=${result.bookid}">RETURN</button>
                        </form>
